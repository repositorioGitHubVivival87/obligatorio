        ...
        if (!(cadena == null)) {
            ...
            while ((pointer + 16) <= cadena.length()) {
                ...
                if (isNumeric(potencialCartao)) {
                    if (potencialCartao.substring(0, 1).equals("4") || potencialCartao.substring(0, 1).equals("5") || potencialCartao.substring(0, 1).equals("6")) {
                        if (validoDigito(potencialCartao)) {
                            cadenaMascarada = cadenaMascarada + potencialCartao.substring(0, 6) + "******" + potencialCartao.substring(12);
                            pointer = pointer + 16;
                        } else {
